...
def model_fn(features, labels, mode, params):
  ...
  model = deep_speech_model.DeepSpeech2(
      ...
      num_classes, flags_obj.use_bias, tf.bfloat16)
...
def define_deep_speech_flags():
  ...
  flags_core.set_defaults(
      model_dir="/data/deepspeech_test/models/research/deep_speech1/bf16_model_dir/",
      export_dir="/tmp/deep_speech_saved_model_bf16/",
      train_epochs=10,
      batch_size=16,
      hooks="")
