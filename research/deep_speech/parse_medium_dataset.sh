...
train_file="./librispeech_data/train_medium_dataset.csv"
eval_file="./librispeech_data/eval_medium_dataset.csv"
...
final_train_file="./librispeech_data/final_train_medium_dataset.csv"
final_eval_file="./librispeech_data/final_eval_medium_dataset.csv"
